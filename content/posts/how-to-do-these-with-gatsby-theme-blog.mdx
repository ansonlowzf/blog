...
What the... why all MDX styling has gone?!
...
I need to merge the default code and my code, There are 2 options

1. Merge with either **deepmerge** or **lodash.merge** npm packages
2. Use JavaScript rest operator

As a new modern coding noob, of course I will use the rest operator
...
I'm writing **How to add Google Analytics to Gatbsyjs Sit** article, I build the site in production and search for the Tracking ID. The terminal is throwing a red warning to me
...
404 page is not created by default for gatsby-theme-blog. Gatsby's team should do something about it.
...
Without thinking further, under the **src** folder I create a directory **pages** and add a file named **404.js**

Then I go to **gatsby-starter-default**'s <a href="https://github.com/gatsbyjs/gatsby-starter-default/blob/master/src/pages/404.js" target='_blank' rel='noreferrer noopener'>github source code</a> to copy the 404.js code and modify a bit
...
Wolala... 404.html created as easy as abc. Thanks to Gatbsyjs
